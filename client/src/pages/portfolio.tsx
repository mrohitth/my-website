        ...
        <div className="flex items-center gap-4">
          ...
          <div className="relative flex items-center justify-center h-12 w-12 rounded-xl bg-portfolio-primary/10 border border-portfolio-primary/20">
            ...
            <motion.div
              ...
              animate={isOpen ? { scale: [1, 1.5, 1], opacity: [1, 0.5, 1] } : { scale: 1, opacity: 1 }}
        ...
        <div className="flex items-center gap-3">
          ...
          >
            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M4 6L8 10L12 6" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-portfolio-primary" />
            </svg>
          </motion.div>
        </div>
      </button>
    ...
    <div className="relative min-h-screen bg-portfolio-background text-portfolio-foreground subtle-dots">
      ...
      <section id="projects" className="py-20 px-4 bg-portfolio-background relative">
        ...
        <div className="max-w-6xl mx-auto relative">
          ...
          {/* Interactive Data Platform Sandbox — Collapsed by Default */}
          <div className="mb-12">
            <SandboxWrapper />
          </div>
